...
def deleteinstancee():
    if request.method == 'POST':
        ...
        deletescript = f"gcloud compute instances delete instance-1 instance-2 instance-3 instance-4 --project=silent-card-399405 --access-token-file=token.txt --quiet --zone={zone}"
